...
function read(a)
{
    ...
    for(i in arr){
        ...
        document.getElementById("mapo").innerHTML= "<b><u>PO Code:</u> " + arr[0] + "</b>";    
        document.getElementById("mact").innerHTML= "<b><u>Detail Code:</u> " + arr[1] + "</b>";    
        document.getElementById("soluong").innerHTML= "<b><u>Amount:</u> " + arr[2] + "</b>";    
    }
