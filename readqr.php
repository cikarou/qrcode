...
<body>
  <div class="row">
          <a href="index.php" style="float: right;">Generate QR Code</a> 
      <div id="test1" class="col s12">
        <div class="container">
          <div class="row">
            <h4 style="color: blue; text-align: center;">Read QR Code</h4>
            <div style="margin: 0 auto; text-align: center; width: 500px" class="z-depth-2">
              ...
              <div style="text-align:  right; margin-right: 10px;">
                <a class="waves-effect waves-light btn blue" onclick="load();"><i class="material-icons left">play_circle_outline</i>Begin</a> 
                <a class="waves-effect waves-light btn red" onclick="stop();"><i class="material-icons left">not_interested</i>Stop</a> 
              </div>
